...
const uint16_t lut_row_index[4][24*24];
const uint16_t lut_column_index[4][24*24];
...
void host_map_write(uint16_t ofs, uint8_t data)
{
    ...
    uint8_t map_sz= MinxRegs[VREG_PRC_MODE]>>4;
    uint16_t tile_row= lut_row_index[map_sz][ofs];
    uint16_t tile_col= lut_column_index[map_sz][ofs];
